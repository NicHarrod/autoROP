...
class ROPChainBuilder:
    ...
    def add_gadget(self, gadget_tuple, pop_type=None, value_bytes=None):
        ...
        important={}
        # 1. Save important registers that will be altered by this gadget
        for i in affected:
        ...
        # 2. If this gadget is a pop, add the value to be popped
        ...
        # add 1 dummy value to satisfy the extra pop.
        
        if junk_count > 0:
            chain += self.dummy_bytes * junk_count 
        # 4. Restore important registers altered by this gadget
        ...
        for reg,old_val in important.items():
            ...
            # Recurse to add the restore gadget
